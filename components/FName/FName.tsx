...
<section className="py-24 flex items-center min-h-screen justify-center bg-gradient-to-r from-cyan-500 to-blue-500">
  <motion.div className="mx-auto max-w-[43rem]" initial={{ opacity: 0, scale: 0.5 }}
    ...
    <a
      ...
      <a href="#experience-section" onClick={(event) => handleLinkClick(event, "education-section") }className="bg-emerald-400 transform rounded-md text-white px-5 py-3 font-medium text-slate-900 transition-colors hover:bg-emerald-300">Educación </a>
