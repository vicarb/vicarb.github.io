...
const Contact = () => {
  ...
  return (
    ...
    <div className="max-w-md md:max-w-lg mx-auto bg-blue-500 rounded-md shadow-md overflow-hidden">
      ...
      {isSuccess && (
        <div className="px-8 py-6 bg-green-500 text-white text-center">
          <p className="font-medium text-lg">Message sent!</p>
          <button  onClick={() => setIsSuccess(false)} className="mt-4 bg-white text-green-500 font-medium py-2 px-4 rounded-md text-lg">Done</button>
        </div>
      )}
    </div>
  </div>
